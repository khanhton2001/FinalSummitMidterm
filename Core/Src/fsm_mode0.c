...
void fsm_Mode0_run(){
	...
	case 3:
		...
		if(isButton2Pressed() == 1){ MODE = 1  ; setTimer1(100) ; setTimer4(1000)  ; checker = 0 ;}
		if(isButton3Pressed() == 1){ MODE = 2 ; setTimer1(100) ; setTimer4(1000)   ; checker = 0 ;}
	    if(isButton1Pressed() == 1){ MODE = 0 ; setTimer1(100) ; setTimer4(1000)   ; checker = 0 ;}
